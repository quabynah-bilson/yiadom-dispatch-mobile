...
import com.yiadom.dispatch.customer.databinding.FragmentPickupLocationBinding;
...
public class PickupLocationFragment extends Fragment {
    ...
    @NonNull
    public static PickupLocationFragment newInstance(OnPageNavigationListener navigationListener) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPickupLocationBinding.inflate(inflater);
